import { A as updatePlaylist, F as require_jsx_runtime, I as require_react, R as __toESM, a as createPlaylist, o as deletePlaylist, p as getPlaylists, w as resolveMediaUrl } from "./store-CF1ZVsO4.js";
import { s as useNavigate } from "./dist-DQ47giAv.js";
import { B as X, E as Plus, F as Type, P as Trash2, S as Music, k as Search, n as useDataSaver, p as ImageIcon, y as Loader2, z as WifiOff } from "./DataSaverContext-JVn9PKBV.js";
import { t as ImageWithFallback } from "./ImageWithFallback-BHtvC2dU.js";
import { t as triggerImpact } from "./haptics-BGTWm9ug.js";
import { _ as useSensor, c as rectSortingStrategy, d as DndContext, f as KeyboardSensor, g as closestCenter, h as TouchSensor, l as sortableKeyboardCoordinates, o as SortableContext, p as MouseSensor, s as arrayMove, u as useSortable, v as useSensors, y as CSS } from "./index-BQ5xvPba.js";
...
function Playlists() {
	...
	const sensors = useSensors(useSensor(TouchSensor, { activationConstraint: {
		delay: 350,
		tolerance: 8
	} }), useSensor(MouseSensor, { activationConstraint: { distance: 8 } }), useSensor(KeyboardSensor, { coordinateGetter: sortableKeyboardCoordinates }));
	const loadPlaylists = (0, import_react.useCallback)(async () => {
		...
		try {
			...
			console.log("Playlists API raw response:", response);
			const fetched = Array.isArray(response) ? response : Array.isArray(response?.data) ? response.data : [];
			console.log("Playlists processed:", fetched.length, fetched);
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									className: `p-3 rounded-full transition-colors flex items-center justify-center ${shouldDeferNetwork ? "opacity-40 cursor-not-allowed" : ""}`,
									disabled: shouldDeferNetwork,
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, {
										className: "w-6 h-6",
										style: { color: shouldDeferNetwork ? "#666" : "#f6b012" }
									})
								})
							]
						}),
