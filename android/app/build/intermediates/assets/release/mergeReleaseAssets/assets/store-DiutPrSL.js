...
if (isFileProtocol) ensureConnection();
api.interceptors.response.use((response) => {
	...
	if ((networkError || status === 502 || status === 503 || status === 504) && retried < apiBases.length - 1) {
...
//#endregion
export { require_jsx_runtime as A, searchLyrics as C, uploadAlbumCover as D, updateTrack as E, __commonJSMin as M, __toESM as N, uploadArtistCover as O, saveTrackLyrics as S, updatePlaylist as T, removeTrackFromPlaylist as _, downloadTrack as a, resolveMediaUrl as b, getHistory as c, getShareLink as d, getTrack as f, mergeAlbums as g, getTracks as h, deletePlaylist as i, require_react as j, uploadTrackCover as k, getPlaylist as l, getTrackStreamUrl as m, api as n, getAlbums as o, getTrackLyrics as p, createPlaylist as r, getArtists as s, usePlayerStore as t, getPlaylists as u, renameArtist as v, searchTracks as w, saveSyncedLyrics as x, reorderPlaylistTracks as y };
