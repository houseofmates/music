import { F as require_jsx_runtime, I as require_react, M as uploadAlbumCover, R as __toESM, b as mergeAlbums, l as getAlbums, w as resolveMediaUrl } from "./store-CF1ZVsO4.js";
import { s as useNavigate } from "./dist-DQ47giAv.js";
import { B as X, V as Zap, g as Layers3, i as Check, k as Search, n as useDataSaver, y as Loader2, z as WifiOff } from "./DataSaverContext-JVn9PKBV.js";
import { t as ImageWithFallback } from "./ImageWithFallback-BHtvC2dU.js";
import { t as triggerImpact } from "./haptics-BGTWm9ug.js";
import { _ as useSensor, c as rectSortingStrategy, d as DndContext, f as KeyboardSensor, g as closestCenter, l as sortableKeyboardCoordinates, m as PointerSensor, o as SortableContext, s as arrayMove, u as useSortable, v as useSensors, y as CSS } from "./index-BQ5xvPba.js";
						...
						children: [
							...
							!loading && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [selectionMode && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									className: `inline-flex items-center justify-center rounded-xl p-2 transition-colors ${selectionMode ? "bg-[#1a1a1a] text-white" : "bg-[#111] text-[#9b9b9b] hover:bg-[#1a1a1a]"} ${shouldDeferNetwork ? "opacity-40 cursor-not-allowed" : ""}`,
									disabled: shouldDeferNetwork,
									children: selectionMode ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { className: "h-4 w-4" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Layers3, { className: "h-4 w-4" })
								})]
							}),
							loading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-8" })
						]
					}),
