...
- Music files at `/run/media/house/nextcloud/house/files/media/music`
...
### Adding Music
1. Copy music files to `/run/media/house/nextcloud/house/files/media/music`
...
ls /run/media/house/nextcloud/house/files/media/music
